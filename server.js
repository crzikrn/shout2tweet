...
var T = new Twit({
  consumer_key:         'YOUR_APIKEY', 
  consumer_secret:      'YOUR_APIKEY',
  access_token:         'YOUR_APIKEY',
  access_token_secret:  'YOUR_APIKEY'
});
...
function getTweets(request) {
  // Here's the string we are searching for
